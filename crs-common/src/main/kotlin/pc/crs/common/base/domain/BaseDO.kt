...
abstract class BaseDO(
        ...
        @JsonIgnore @Column(nullable = false) var createTime: LocalDateTime = LocalDateTime.now(),
        @JsonIgnore @Column(nullable = false) var modifiedTime: LocalDateTime = LocalDateTime.now(),
